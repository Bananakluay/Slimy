...
public class MenuButton {
	...
	private GameStatesManager state;
	private BufferedImage[] imgs;
	private boolean mouseOver, mousePressed;
	private Rectangle bounds;

	public MenuButton(int xPos, int yPos, int rowIndex, GameStatesManager state) {
		this.xPos = xPos;
		this.yPos = yPos;
	...
	private void loadImgs() {
		...
		BufferedImage temp = LoadSave.GetSpriteAtlas(LoadSave.MENU_BOTTONS);
